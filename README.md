...
No. All processing happens locally on your computer. Your files stay on your hard drive.

Can I use this without a graphics card? 
Yes, but the responses take more time to generate. The processor handles the math if no graphics card is available.

How do I update the software?
The application checks for updates automatically when you launch it. If a new version exists, the software prompts you to download and install it.
